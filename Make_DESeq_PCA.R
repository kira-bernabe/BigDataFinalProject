...
PCAplot$group <- c("B1-C-UV_S142", "B2-C-NonUV_S143", "B3-C-June_S144",  "B4-C-June_S145", "B3-S4-UV_S140", "B4-S4-NonUV_S141", "B5-S4-June_S146", "B8-S4-June_S147")
...
ggplot(PCAplot, aes(PC1, PC2, color=condition)) +
  geom_point(size=2) +
  geom_text(aes(label=group), hjust=0.5, vjust=-0.5) + # this is commented out in original code
  ggtitle("PCA Plot of control vs. experimental function data") + #qualify which data it is
